      ...
      <main className="max-w-5xl mx-auto px-5 sm:px-8 py-8 sm:py-12">
        ...
        <section className="panel-card p-5 sm:p-7">
          <div className="flex items-start gap-3 mb-4">
            ...
            <div>
              <h2 className="text-lg sm:text-xl font-bold text-ink">Open source</h2>
              <p className="text-xs text-ink-3 mt-0.5">R&eacute;utilisez ce projet pour n&apos;importe quelle &eacute;lection</p>
            </div>
          </div>
          <p className="text-sm text-ink-2 leading-relaxed mb-4">
            L&apos;int&eacute;gralit&eacute; du code source de ce site est publi&eacute;e en open source. L&apos;objectif : permettre &agrave; quiconque
            de reproduire cette d&eacute;marche d&apos;analyse pour d&apos;autres &eacute;lections, dans d&apos;autres villes, dans d&apos;autres pays.
            M&ecirc;me grille, m&ecirc;me rigueur, m&ecirc;me transparence.
          </p>
          <div className="space-y-2.5">
            <a
              ...
              className="group playful-dash bg-white p-3.5 flex items-start gap-3 hover:shadow-sm transition-shadow block"
            >
              <span className="w-2 h-2 rounded-sm bg-score-solid mt-1.5 shrink-0" />
              <div>
                <div className="text-sm font-semibold text-ink group-hover:text-accent transition-colors">election-lab</div>
                <div className="text-xs text-ink-3 mt-0.5">Template complet du site, pr&ecirc;t &agrave; d&eacute;ployer. Next.js, Tailwind, donn&eacute;es d&apos;exemple incluses.</div>
              </div>
            </a>
            <a
            ...
            <a
              ...
              className="group playful-dash bg-white p-3.5 flex items-start gap-3 hover:shadow-sm transition-shadow block"
            >
              <span className="w-2 h-2 rounded-sm bg-accent mt-1.5 shrink-0" />
              <div>
                <div className="text-sm font-semibold text-ink group-hover:text-accent transition-colors">editorial-ui</div>
                <div className="text-xs text-ink-3 mt-0.5">Design system CSS/Tailwind style presse, avec d&eacute;mos standalone.</div>
              </div>
            </a>
          </div>
          <p className="text-xs text-ink-4 mt-4">
            Tous les repos sont sous licence MIT. Forkez, adaptez, d&eacute;ployez librement.
          </p>
        </section>
